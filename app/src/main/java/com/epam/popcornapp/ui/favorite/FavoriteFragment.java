...
public class FavoriteFragment extends BaseMvpFragment implements
        MainPresenterView,
        BaseMoreView,
    ...
    @InjectPresenter
    FavoriteMoviePresenter favoriteMoviePresenter;

    @InjectPresenter
    FavoriteTvPresenter favoriteTvPresenter;
    ...
    public void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        ...
        if (resultCode == ChangeType.FAVORITE) {
            refresh();
        }
    }
    ...
    @Override
    public void refresh() {
        favoriteMoviePresenter.refreshData();
        favoriteTvPresenter.refreshData();
    }
    ...
    public void onMoreClicked(@TileType final String type) {
        if (type.equals(TileType.MOVIE)) {
            mainPresenter.onMorePressed(FavoriteMoviePresenter.class.getName());
        } else {
            mainPresenter.onMorePressed(FavoriteTvPresenter.class.getName());
        }
    }
